...
test.describe("Athena API Tests - End to End test", function () {
    ...
    test("End to End Test to check if all Athena APIs work well in conjunction",async ({request}) => {
        
        //Test to check if server is up
        await test.step("Verify the server is up and running - Verify Athena-\"Get-Test\" API with status code as 200",async () => {
        ...
        await test.step("Retrieve document structure - Verify Athena-\"Get-RetrieveDocument\" API with status code as 200.",async () => {
        ...
        //Upload document
        await test.step("Upload document - Verify Athena-\"Post-StoreDocument\" API with status code as 200.",async () => {
        ...
        //Retrieve documents
        await test.step("Retrieve documents - Verify Athena-\"Get-RetrieveDocument\" API with status code as 200.",async () => {
        ...
        await test.step("Get document with document ID: " + _documentIDGenerated + " - Verify Athena-\"Get-GetDocument\" API with status code as 200.",async () => {
        ...
        await test.step("Get document with document ID: {\"" + _documentIDGenerated + "\"} - Verify Athena-\"Get-GetDocuments\" API with status code as 200.",async () => {
        ...
        await test.step("Update document with document ID: " + _documentIDGenerated + " - Verify Athena-\"Put-Store Document\" API with status code as 200.",async () => {
