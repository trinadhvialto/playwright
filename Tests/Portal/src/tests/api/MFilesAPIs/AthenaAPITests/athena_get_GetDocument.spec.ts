...
test.describe("Athena API Tests - Get Documents - Parameter is a string with document ID", function() {
    ...
    test("Verify Athena-\"Get-GetDocument\" API with status code as 200 when correct document ID is passed.",async () => {
    ...
    test("Verify Athena-\"Get-GetDocument\" API with status code as 400 when incorrect document ID is passed.",async () => {
    ...
    //Pass incorrect url
    test("Verify Athena-\"Get-GetDocument\" API with status code as 404 when incorrect url is passed.",async () => {
        let url = urlSuffix + "/" + Params.MFileParams.GetDocument.IncorrectDocumentID;
